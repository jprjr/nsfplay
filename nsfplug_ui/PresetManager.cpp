...
bool
PresetManager::CreatePreset(ini::NSFPlayerConfig *cfg, const CString &name )
{
  CString sect;
...
bool
PresetManager::LoadPreset(ini::NSFPlayerConfig *cfg, const CString &name)
{
...
bool
PresetManager::SavePreset(ini::NSFPlayerConfig *cfg, const CString &name)
{
  for(int i=0;preset_range[i]!=NULL;i++)
